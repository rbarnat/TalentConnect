...
[
  ...
  {:title => "Upload ta vidéo sur Youtube", :description => "Pour devenir un vrai Youtubeur tu dois d'abord apprendre à uploader tes vidéos",:picture_name => "talent_video_youtube_upload.jpg", :category_id =>  3},
  ...
  {:title => "Initiation à l'électronique", :description => "Comment le courant circule dans un fil ? Apprenez-en plus sur la tension d'un circuit et construisez votre super circuit ! Repartez avec votre propre kit de video-surveillance IP pour filmer les ébats de votre femme. Le divorce est dans la poche !",:picture_name => "talent_electronics.jpg", :category_id =>  2},

  {:title => "Guitare: s'accompagner", :description => "Pour apprendre à accompagner à la guitare les chansons que l’on aime... S’accompagner en chantant, chanter en s’accompagnant !",:picture_name => "talent_guitar.jpg", :category_id =>  7},
  {:title => "Guitare et improvisation", :description => "Le plus difficile dans l'improvisation, c'est de se lancer. Je vais vous montrer que l'improvisation est bien plus à votre portée que vous n'auriez pu l'imaginer !",:picture_name => "talent_guitar1.jpg", :category_id =>  7},
  {:title => "Solo de guitare", :description => "Méthode de guitare progressive et structurée pour apprendre à jouer note à note les plus grands solos de l'histoire du Rock. Jimmy Hendrix n'a qu'a bien se tenir !",:picture_name => "talent_guitar2.jpg", :category_id =>  7},
  {:title => "Compo à la guitare", :description => "Les manières de composer seront illustrées pour différents ensembles musicaux. On commencera avec quelques principes généraux, puis on appliquera ces principes pour une formation guitare-voix, et enfin pour un quintet instrumental.",:picture_name => "talent_guitar3.jpg", :category_id =>  7},
  {:title => "La guitare électrique", :description => "Vous vous ferez plaisir sur des styles différents : rock, heavy metal, jazz, blues... La sonorité n'a plus rien à voir avec celle d'une guitare acoustique.",:picture_name => "talent_guitar4.jpg", :category_id =>  7},
  
  {:title => "Les filtres vidéo", :description => "Les meilleurs filtres instagram pour avoir plus de followers!",:picture_name => "talent_video_filters.jpg", :category_id =>  3},
  # {:title => "Guitare : les accords", :description => "Apprendre les 8 principaux accords de guitare faciles pour débutants! Ils nous permettent de jouer un très grand nombre de morceaux à la guitare.",:picture_name => "talent_guitar5.jpg", :category_id =>  7},
  {:title => "Guitare et voix", :description => "Ces premiers cours de guitare pour débutants sont parfaits pour commencer. Nous allons aborder tout un tas de sujets pour partir avec les bons réflexes. Comment tenir sa guitare, son médiator ? Ou encore comment savoir lire les notes de guitare ou même comment accorder sa guitare ?",:picture_name => "talent_guitar6.jpg", :category_id =>  7},
  ...
  {:title => "Lumière et vidéos", :description => "Gère ta lumière et filme comme un pro avec ce cours proposé par un vrai cinéaste!",:picture_name => "talent_video_light.jpg", :category_id =>  3},
